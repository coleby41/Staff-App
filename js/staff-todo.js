            ...
            const itemsHtml = subitemsByProject[projectId].map(sub => {
                ...
                <div class="info-item project-todo-item">
                    ...
                    <div class="project-todo-item__right">
                        <a class="workbook-btn workbook-btn--preview project-todo-item__due${dueTierClass}" href="/pages/project-todo.html?id=${encodeURIComponent(sub.project_id)}">${escapeHtmlStaffTodo(due.text)}</a>
                    </div>
                </div>
            `;
            }).join("");
