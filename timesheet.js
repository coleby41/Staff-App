...
/* ===========================
   NOTIFICATIONS
   Now handled by the shared notifications.js (loaded via <script src> in
   time sheet.html), which self-initializes and persists read state to
   Supabase instead of localStorage. See notifications.js.
=========================== */
